...
xpath_url="//div[@class='section-item']/a/@href"
...
for url in all_urls:
        ...
        xpath_date="//p[@class='post-date-2']/span"
        date = response.html.xpath(xpath_date)
        fecha = date[2].text + " " + date[0].text + " " + date[1].text
        print(fecha)
        ...
        #CONTENIDO
        xpath_texto="//div[@class='entry-content clearfix']//p"
