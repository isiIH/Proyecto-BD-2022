...
URL = "https://eltipografo.cl/inicio"
...
for url in all_urls:
        ...
        #URL
        article_url = "https://eltipografo.cl" + url
        print(article_url)
        response = session.get(article_url,headers=headers)

        #FECHA DE PUBLICACION
        xpath_date="//div[@class='container']//small[@class='grey py-1 my-2']"
        ...
        #CONTENIDO
        xpath_texto="//div[@class='col-lg-8 col-sm-12 col-md-9']//p"
